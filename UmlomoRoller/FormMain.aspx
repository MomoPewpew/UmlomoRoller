...
<body style="height: 1920px; width: 1080px">
    <form id="FormMain" runat="server">
        <p style="height: 50px; margin-bottom: 10px; width: 1080px;">
            <asp:Label ID="labelStateMain" runat="server" Font-Size="XX-Large" Height="50px" style="margin: 10px" Text="State of target:" Width="1060px"></asp:Label>
        </p>
        ...
        <asp:TextBox ID="TextOutput" runat="server" Height="1690px" OnTextChanged="TextOutput_TextChanged" style="margin: 10px" Width="695px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
            ...
            <asp:Label ID="labelBuffsMain" runat="server" Font-Size="XX-Large" Height="40px" style="margin: 10px 0px 10px 10px" Text="Buffs:" Width="340px"></asp:Label>
                        <br />
            ...
            <asp:Button ID="Button13" runat="server" Height="50px" OnClick="Button1_Click" style="margin: 10px" Text="Button" Width="340px" />
                        <br />
            <asp:Button ID="Button15" runat="server" Height="50px" OnClick="Button1_Click" style="margin: 10px" Text="Button" Width="340px" />
                        <br />
                        <br />
                        <br />
                        <br />
        ...
        <asp:Button ID="Button4" runat="server" Height="50px" OnClick="Button1_Click" style="margin: 10px" Text="Roll" Width="1060px" />
    </form>
</body>
</html>
